      ...
      <main className="max-w-4xl mx-auto px-4 py-10 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-2xl">
            ...
            and displays the sentiment predicted by your scikit-learn model.
          </p>
        </section>
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          ...
          <div className="rounded-2xl bg-white/90 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-sm p-5 flex flex-col justify-between gap-4">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-500">
              This card simply reflects the string returned by your backend
              (`positive` or `negative`). You can extend the API later to
              include scores, reasons, or more analytics and render them here.
            </p>
          </div>
        </section>
      </main>
